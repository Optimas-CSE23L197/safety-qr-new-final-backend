 ...
 */
export function buildTokenGenerationPayload(orderId, batchId, batchSize, startIndex, options = {}) {
  return {
    orderId,
    batchId,
    batchSize,
 ...
 */
export function buildCardDesignPayload(orderId, cardIds, templateId, options = {}) {
  return {
    orderId,
    cardIds,
    templateId,
