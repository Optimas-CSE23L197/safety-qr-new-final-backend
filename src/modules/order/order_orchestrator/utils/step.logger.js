...
export async function stepLog(
  ...
  return _write(stepExecutionId, orderId, 'info', message, context, jobExecutionId);
}
...
export async function stepWarn(
  ...
  return _write(stepExecutionId, orderId, 'warn', message, context, jobExecutionId);
}
...
export async function stepError(
  ...
  return _write(stepExecutionId, orderId, 'error', message, context, jobExecutionId);
}

async function _write(stepExecutionId, orderId, level, message, context, jobExecutionId) {
  try {
